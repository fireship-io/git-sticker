...
(async () => {
  const answers = await inquirer.prompt([
    ...
    {
      type: "input",
      name: "favorite video game",
      message: "Your favoriate video game",
    },
    {
      type: "input",
      name: "favorite video game",
  ...
  console.log(`
    ${chalk.blueBright(
      "Step 1:"
    )} Copy the green text above - it's your encrypted address. Nobody can read it but me. 
    ${chalk.blueBright("Step 2:")} Create a new file named ${chalk.bgBlue(
